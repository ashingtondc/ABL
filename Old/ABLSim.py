...
if __name__ == '__main__':
    ...
    parser.add_argument("-cd", "--cycspeeddistr",  type=int, default=0,    help="specify cyclist speed distribution"
            "(0=all cyclists travel at cycspeed, 1=normal distribution with 85th percentile at cycspeed value)")
    parser.add_argument("-pd", "--pedspeeddistr",  type=int, default=0,    help="specify pedestrian speed distribution"
            "(0=all pedestrians travel at pedspeed, 1=normal distribution with 85th percentile at pedspeed value)")
    parser.add_argument("-vd", "--mvspeeddistr",   type=int, default=0,    help="specify vehicle speed distribution"
